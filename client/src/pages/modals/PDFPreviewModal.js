...
const PDFPreviewModal = ({ open, onClose, pdfUri, orden }) => {
  ...
  return (
    <Modal open={open} onClose={onClose}>
      <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', p: 2, bgcolor: 'white', borderRadius: 1, outline: 'none', width: '80%', maxWidth: '800px', margin: 'auto', mt: 5 }}>
        <Typography variant="h6" mb={2}>Vista previa de la orden de trabajo</Typography>
        {pdfUri ? (
          <iframe
            src={pdfUri}
